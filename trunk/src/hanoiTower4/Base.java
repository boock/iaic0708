...
public class Base {
	...
	// De typo { A esta sobre? , B esta sobre? , C esta sobre? , D esta sobre?}
	...
	public boolean hayAlgoSobre(char c) {
		...
		switch(c) {
			...
			case 'D' : if( ( board[0] != 'D' ) && ( board[1] != 'D' ) && ( board[2] != 'D' ) ) return false; break;
			}
	...
	public void mover(String mov) {
		...
		if ( mov.equals(MC_1) ) board[2] = enTapa('1');
		if ( mov.equals(MC_2) ) board[2] = enTapa('2');
		if ( mov.equals(MC_3) ) board[2] = enTapa('3');
		
		if ( mov.equals(MD_1) ) board[3] = '1';
		if ( mov.equals(MD_2) ) board[3] = '2';
		if ( mov.equals(MD_3) ) board[3] = '3';
	}
	/**
	...
	public boolean movimientoPosible(String where) {
		...
		if ( where.equals(MD_1) && ('1' == quePlaza('D') ) ) retVal = false;
		...
		if ( where.equals(MD_2) && ('2' == quePlaza('D') ) ) retVal = false;
		...
		if ( where.equals(MD_3) && ('3' == quePlaza('D') ) ) retVal = false;
		...
		if ( where.equals(MD_1) && hayAlgoSobre('D') )  retVal = false;
		...
		if ( where.equals(MD_2) && hayAlgoSobre('D') )  retVal = false;
		...
		if ( where.equals(MD_3) && hayAlgoSobre('D') )  retVal = false;
		...
		if ( where.equals(MD_1) && ( '1' == quePlaza('A') ) ) retVal = false;
		if ( where.equals(MD_1) && ( '1' == quePlaza('B') ) ) retVal = false;
		if ( where.equals(MD_1) && ( '1' == quePlaza('C') ) ) retVal = false;
		...
		if ( where.equals(MD_2) && ( '2' == quePlaza('A') ) ) retVal = false;
		if ( where.equals(MD_2) && ( '2' == quePlaza('B') ) ) retVal = false;
		if ( where.equals(MD_2) && ( '2' == quePlaza('C') ) ) retVal = false;
		...
		if ( where.equals(MD_3) && ( '3' == quePlaza('A') ) ) retVal = false;
		if ( where.equals(MD_3) && ( '3' == quePlaza('B') ) ) retVal = false;
		if ( where.equals(MD_3) && ( '3' == quePlaza('C') ) ) retVal = false;
