...
//	 */
//		// Crea un Base colocado (para que lo descoloque el usuario)
//		labels = new Label[9];
//		tab = new Base();
//		
...
//				// Si todavía no hay una solución, se puede mover el Base
//				if (agent==null) 
...
//		});
//		
//		Composite cReglas = addTabIntro("El objetivo es colocar los números del 1 al 8 en un Base de 3x3, dejando el hueco en " +
//				"el centro. Las fichas se pueden mover hacia el hueco.\n\n" +
//				"Utiliza las teclas WASD como si fueran flechas para mover las fichas y descolocar el Base.\n" +
//				"También puedes pulsar el botón Mezclar para descolocar el Base (cada vez que se pulsa hace" +
//				"30 movimientos.\n");
...
//	}
//	
//	private void resolverDSL(Base Base, int profundidad) {
//		// Resolución del puzzle
//		try {
//			String salida = "Puzzle 8 :: Búsqueda en profundidad (DLS)\n\nLímite: " + String.valueOf(profundidad) + "\n";
//			salida +=       "-------------------------\n\n";
//			// Crea el problema con el Base inicial, la función sucesor y el Base solución
...
//	}
//	
//	private void resolverAstar(Base Base) {
//		// Resolución del puzzle
//		try {
